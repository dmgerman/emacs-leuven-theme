...
;;      (highlight-line '(:background "#FBFFAD"))
      (highlight-line '(:background "#FFFFE7")) ; #F5F5F5
      (highlight-line '(:foreground "#000000")) ; #F5F5F5
...
;      (mail-unread '(:weight normal :foreground "black"))
;      (marked-line '(:weight bold :foreground "red" :background "pink"))
      (match '(:weight bold :background "#FBE448")) ; occur patterns
      (ol1 '(:height 1.2 :weight bold :overline "#A7A7A7" :foreground "#3C3C3C" :background "#F0F0F0"))
  ...
  (custom-theme-set-faces
   ...
   `(cfw:face-title ((,class (:height 1.2 :foreground "#676767" :weight bold :inherit variable-pitch))))
   ...
   `(org-agenda-structure ((,class (:height 1.2 :weight bold :foreground "#1F8DD6"))))
   ...
   `(org-document-title ((,class (:family "Sans Serif" :height 1.2 :weight bold :foreground "black"))))
